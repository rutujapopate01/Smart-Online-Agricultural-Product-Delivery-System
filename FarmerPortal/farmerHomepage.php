                ...
                <div class="card-deck row text-center" style="display: flex; flex-wrap: wrap;">
                     <div class="card">
                          ...
                          <div class="card-body">
                               ...
                               <br>
                               <h5 class="card-text">Upload and Edit Your Products via Portal </h5>
                          </div>
                     </div>
                     <div class="card">
                          <p class="aligncenter">
                          ...
                          <div class="card-body">
                               ...
                               <br>
                               <h5 class="card-text">Sell your products directly to verified Buyers</h5>
                          </div>
                     </div>
                     <div class="card">
                          <p class="aligncenter">
                          ...
                          <div class="card-body">
                               ...
                               <br>
                               <h5 class="card-text">Form your own community where you have low food product wastage</h5>
                          </div>
                     </div>
                </div>
           </div>
